...
public class HipsCyberInterface extends LimbInterface {
    ...
    public HipsCyberInterface() {
        super(8, 9, false, LimbType.HIPS);
        ...
        this.setCameraPosOffset(new Vec3(-(normalizeDir.x * 0.6),-0.6f,-(normalizeDir.z * 0.6)));
    }
