...
public class AssemblyRecipeInfoWidget extends InformativeButton {
    ...
    protected void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        if (this.screen.selectedRecipe != null) {
            ...
            LimbType type = this.screen.selectedRecipe.getResultModule().get().attachment;
            ...
            guiGraphics.pose().translate(this.getRealX() + (((this.getRealWidth()*16)+17+17)/2) - 16f, this.getRealY() + 10, 0);
